...
import { IDeleteUsersInputDTO, IEditUsersInputDTO, IGetUserDBDTO, IGetUsersArrayResponseOutputDTO, IGetUsersInputDTO, IGetUsersResponseOutputDTO, ILoginInputDTO, ISingUpInputDTO, ISingUpOutputtDTO, User, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public getUsers = async (input: IGetUsersInputDTO) => {
        ...
        const getUsersInputDB: IGetUserDBDTO = {
            search,
            order,
            sort,
            limit,
